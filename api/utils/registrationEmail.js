                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td align="left" valign="middle" width="50%"><span
                                                                    style="font-weight: bold;margin:0;color:#00A8CC;white-space:normal;display:inline-block;text-decoration:none;font-size:12px;line-height:20px">${Date()
                                                                        .toString()
                                                                        .substring(
                                                                          0,
                                                                          16
                                                                                            ...
                                                                                            <td align="center" width="100%"
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <a style="padding:0.6em 1em;border-radius:600px;color:#ffffff;font-size:14px;text-decoration:none;font-weight:bold"
                                                                                                        href="https://www.instagram.com/ik159/"
